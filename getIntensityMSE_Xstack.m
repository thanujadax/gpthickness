function sigmaMat = getIntensityMSE_Xstack...
...
disp('Estimating similarity curve using MSE of intensity differences along X axis')
...
for z=1:maxNumImages
    ...
    for g=minShift:maxShift
        ...
        [~,MSE_intensity,~,~] = measerr(I(:,1+g:size(I,2)),I(:,1:size(I,2)-g)); % shifted in x         
        k = k + 1;
