...
matFilePath = '/home/thanuja/projects/data/rita/batchrun20160219/distMat';
outputSavePath = '/home/thanuja/projects/data/rita/batchrun20160219/thicknessPredictions';
gpModelSavePath = '/home/thanuja/projects/data/rita/batchrun20160219/gpModels';
...
for i=1:length(distanceMeasuresList)
    ...
    for j=1:length(volumeDirs)
        ...
        for k=1:length(calibrationMethods)
            ...
            mainPredictThicknessOfVolumeGP(imageFileName,outputSavePath,...
