function sigmaMat = getIntensityDeviationXstack...
    (inputImageStackFileName,maxShift,minShift,maxNumImages)
% calculate the sd of intensity difference along X axis.
...
disp('Estimating similarity curve using SD of intensity differences along X axis')
