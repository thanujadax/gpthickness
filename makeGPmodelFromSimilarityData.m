function gpModel = makeGPmodelFromSimilarityData...
...
nlml = gp(hyp, inf, meanfunc, covfunc, likfunc, vX, vY);
disp(' ')
...
fill([vZ; flipdim(vZ,1)], f, [1.0 0.5 0]), hold on,
...
% axis([0,55,0,35]),
axis(axisVect),
grid on, xlabel('Dissimilarity (std. intensity diff.)'), ylabel('Distance (pixels)'); hold off;
